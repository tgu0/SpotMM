...
This repository implements a machine learning-based trading strategy for cryptocurrency markets using high-frequency order book and trade data. The pipeline consists of three main stages: data loading, feature engineering, and strategy backtesting.
